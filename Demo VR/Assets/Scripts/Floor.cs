...
public class Floor : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            case "Magazine":
                magazine.transform.position = magazineTr.position;
                break;
            case "DustCover":
                dustCover.transform.position = dustCoverTr.position;
                break;
            case "GasBulletOut":
                gasBulletOut.transform.position = gasBulletOutTr.position;
                break;
            case "RecoilSpring":
